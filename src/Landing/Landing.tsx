  ...
  return (
    <div className={styles.Body}>
      ...
      <div className={styles.banner}>
        <h1 className={styles.bannerTitle}>ProSuit - Гидрокостюмы нового поколения</h1>
      </div>
      <main className={styles.wrapper}>
      <section className={styles.info}>
        <img className={styles.picture} src="sensors.png" alt="Датчики"/>
        <div className={styles.content}>
        <h2 className={styles.title}>20+ датчиков по всему телу</h2>
        <ul className={styles.list}>
          <li>
            Определение глубины погружения, подводного давления и температуры
            окружающей среды
          </li>
      ...
      <section className={styles.info}>
        ...
        <ul className={styles.list}>
          ...
          <li>Возможность передачи данных на компьютер или телефон в радиусе километра</li>
        </ul>
        </div>
        <img className={styles.picture} src="diver.png" alt="Дайвер"/>
      </section>
      <section className={styles.info}>
      <img className={styles.picture} src="smartdive.png" alt="Очки SmartDive"></img>
        <div className={styles.content}>
        <h2 className={styles.title}>Система SmartDive*</h2>
        <ul className={styles.list}>
          <li>Подводная дополненная реальность</li>
          <li>
            Просматривайте информацию об окружении в реальном времени прямо на
            маске
          </li>
          <li>Моментально определяйте морских обитателей, которых встретите</li>
          <li>Запечатлите то, что видите, с помощью встроенных камер</li>
          <li>Будущее в настоящем</li>
        </ul>
        </div>
      </section>
      <span className={styles.clarification}>*Доступно в премиальных моделях</span>
      </main>
